...
func Test_CommandFlows_report_operation_errors(t *testing.T) {
	tests := []struct {
		...
		{name: "issue list", args: []string{"issue", "list"}, operation: "IssuesByTeamFiltered", contains: "list issues"},
		{name: "issue list project filter", args: []string{"issue", "list", "--project", "project-id"}, operation: "IssuesByTeamFiltered", contains: "list issues"},
		{name: "issue list mine filter", args: []string{"issue", "list", "--mine"}, operation: "IssuesByTeamFiltered", contains: "list issues"},
		{name: "issue list assignee filter", args: []string{"issue", "list", "--assignee", "assignee-id"}, operation: "IssuesByTeamFiltered", contains: "list issues"},
		{name: "issue list label filter", args: []string{"issue", "list", "--label", "label-id"}, operation: "IssuesByTeamFiltered", contains: "list issues"},
		{name: "issue list cycle filter", args: []string{"issue", "list", "--cycle", "cycle-id"}, operation: "IssuesByTeamFiltered", contains: "list issues"},
		...
		{name: "issue start state", args: []string{"issue", "start", "LIT-1"}, operation: "WorkflowStatesByType", contains: "list started workflow states"},
		...
		{name: "project milestone delete", args: []string{"project-milestone", "delete", "project-milestone-id"}, operation: "ProjectMilestoneDelete", contains: "delete project milestone project-milestone-id"},
