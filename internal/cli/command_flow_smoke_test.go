...
func Test_CommandFlows_execute_read_and_write_commands(t *testing.T) {
	tests := []struct {
		...
		{name: "issue create with status alias", args: []string{"issue", "create", "--title", "Created issue", "--status", "done"}, contains: "LIT-2 Created issue [Done]", fake: commandFlowFakeClient{expectedCreateTitle: "Created issue"}},
