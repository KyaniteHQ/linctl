...
| `CycleByID` | query | `cycle` | implemented | `internal/client/generated.go` |
...
| `IssueByID` | query | `issue` | implemented | `internal/client/generated.go` |
...
| `IssueLabelByID` | query | `issueLabel` | implemented | `internal/client/generated.go` |
