...
| Local generated Go operations declared in GraphQL files | 311 | 311 | 311 |
...
| `WorkflowStatesByType` | query | `workflowStates` | generated | `internal/client/internal/gql/generated.go` |
...
| IssueRelation | `issue unrelate` | `Mutation.issueRelationDelete` | Resolve the relation, then compare the pinned team for both linked issues before deleting | guarded_write_command | `linctl --help`, `docs/internal/domain-map.md`, and local GraphQL root |
