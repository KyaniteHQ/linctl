...
96. Notification subscription list
...
97. Notification subscription get
...
All one hundred eleven local scenarios pass under the method above. The complete local suite also passes with `go test ./...`.
