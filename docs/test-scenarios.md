...
100. Notification subscription list
...
101. Notification subscription get
...
All one hundred fifteen local scenarios pass under the method above. The complete local suite also passes with `go test ./...`.
